...
export function Hero() {
	return (
		<section className="min-h-screen flex flex-col justify-center items-center text-center p-4 relative z-10 overflow-visible">
			<motion.div
				...
				<div className="relative inline-block">
					...
					<motion.div
						className="absolute inset-0 bg-gradient-to-r from-teal-500/30 to-blue-600/30 blur-3xl -z-10 rounded-full"
						animate={{
							scale: [1, 1.2, 1],
							opacity: [0.5, 0.8, 0.5],
							rotate: [0, 180, 360],
